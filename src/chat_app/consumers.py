...
from chat_app.models import RoomChatMessage, PrivateChatRoom, UnreadChatRoomMessages
from friend_system.models import FriendList
from account.utils import LazyAccountEncoder
from chat_app.utils import calculate_timestamp, LazyRoomChatMessageEncoder
from chat_app.exceptions import ClientError
from chat_app.constants import *
...
def get_room_or_error(room_id, user):
	...
	# Authentication Check (must be user1 or user2)
